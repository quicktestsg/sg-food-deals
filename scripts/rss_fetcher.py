#!/usr/bin/env python3
"""
RSS Feed Fetcher for SG Food Deals.

Fetches deal/promo entries from Singapore deal blogs via their RSS feeds,
extracts structured data (title, excerpt, image, date, link), and merges
...
FEEDS = [
    {
        ...
        "lang": "en",
        "default_type": "deal",
        "favicon": "https://www.google.com/s2/favicons?domain=singpromos.com&sz=64",
    },
    {
        "name": "AllSingaporeDeals",
        "url": "https://www.allsingaporedeals.com/feeds/posts/default",
        "color": "#3b82f6",
        "lang": "en",
        "default_type": "deal",
        "favicon": "https://www.google.com/s2/favicons?domain=allsingaporedeals.com&sz=64",
    },
    {
        "name": "EverydayOnSales",
        "url": "https://sg.everydayonsales.com/feed/",
        "color": "#8b5cf6",
        "lang": "en",
        "default_type": "deal",
        "favicon": "https://www.google.com/s2/favicons?domain=everydayonsales.com&sz=64",
        "max_entries": 30,  # This feed has 1500+ entries — cap it
    },
    {
        "name": "Eatbook",
        "url": "https://eatbook.sg/feed/",
        "color": "#ef4444",
        "lang": "en",
        "default_type": "deal",
        "favicon": "https://www.google.com/s2/favicons?domain=eatbook.sg&sz=64",
    },
    {
        "name": "LadyIronChef",
        "url": "https://www.ladyironchef.com/feed/",
        "color": "#ec4899",
        "lang": "en",
        "default_type": "deal",
        "favicon": "https://www.google.com/s2/favicons?domain=ladyironchef.com&sz=64",
    },
    {
        "name": "SG榴莲",
        "url": "https://sgliulian.com/feed/",
        "color": "#84cc16",
        "lang": "zh",
        "default_type": "deal",
        "favicon": "https://www.google.com/s2/favicons?domain=sgliulian.com&sz=64",
    },
]

# ─── Keyword Filters ───
# Only keep entries that match deal-related keywords.
# This filters out non-deal posts (transport news, general reviews, etc.)

INCLUDE_KEYWORDS_EN = [
    "1-for-1", "1 for 1", "1for1", "1-for-one",
    "promo", "promotion", "deal", "deals",
    "discount", "sale", "offer", "offers",
    "free", "giveaway", "voucher", "coupon",
    "buffet", "lunch set", "dinner set", "set meal",
    "$", "off", "up to", "flash", "limited time",
    "cravings", "worth it", "must try",
]
...
def matches_keywords(title, summary, lang):
    """Check if entry matches deal keywords. Returns True if it's a deal."""
...
def detect_deal_type(title, summary):
    ...
    text = (title + " " + summary).lower()
    if any(kw in text for kw in ["1-for-1", "1 for 1", "1for1", "买一送一", "半价"]):
        return "1fl"
